...
class ansible_host(db.Model):
    ...
    grps = db.relationship('ansible_group',secondary = rel_grp_host, backref = db.backref('hosts',lazy='dynamic'))
...
class ansible_group(db.Model):
    ...
    invs = db.relationship('ansible_inventory',secondary = rel_inv_grp, backref = db.backref('groups',lazy='dynamic'))
